...
import {TKGasStation} from "../src/TKGasStation2/TKGasStation.sol";
import {TKGasDelegate} from "../src/TKGasStation2/TKGasDelegate.sol";
import "../test/Mocks/MockERC20.sol";

contract TKGasStation2Test is Test {
    ...
    function testERC20Transfer() public {
        console.log("=== TKGasStation2 ERC20 TRANSFER TEST ===");
        ...
        console.log("TKGasStation2 ERC20 transfer gas: %s", gasUsed);
        console.log("");
    }
/*
    function testETHTransfer() public {
        console.log("=== TKGasStation2 ETH TRANSFER TEST ===");
        ...
        console.log("TKGasStation2 ETH transfer gas: %s", gasUsed);
        console.log("");
    }

    function testNotDelegatedRevert() public {
        console.log("=== TKGasStation2 NOT DELEGATED TEST ===");
        ...
        console.log("TKGasStation2 correctly reverts for non-delegated user");
        console.log("");
    }
