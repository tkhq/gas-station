...
interface ITKSmartWalletManager {
    ...
    function validateExecutionSignature(address _executor, uint256 _nonce, uint256 _timeout, uint256 _ethAmount, bytes memory _executionData, bytes calldata _signature) external returns (bool);
