...
import {TKBundledGasStation} from "../src/TKGasStation/TKBundledGasStation.sol";
...
contract DeployTKGasStation is Script {
    ...
    function run() external {
        ...
        bytes memory _creationCode = type(TKBundledGasStation).creationCode;
        ...
        console2.log("TKBundledGasStation deployed at:", _station);
